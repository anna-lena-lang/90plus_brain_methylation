## Supplementary Figure 7: PEN-2 promoter methylation in neurons of the dentate gyrus across different neuropathological scores
...
for(comparison in comparisons){
  ...
  neuron_promoters <- readRDS(paste0("O:/02182022_backup_Lena/90plus/cleaned_mvals/cleaned_mvals_episcore/", comparison, "/neuron/neuron/corrected_pvals/neuron_promoters_DEN_", comparison, "_cleaned_mvals.rds"))
  ...
  colnames(df) <- c("beta", "sample_name", "ensembl_gene_id", "adj.P.Val", 'sample_source', 'block_id', "NIA-AA A score", "NIA-AA B score", "NIA-AA C score", "AD severity score")
